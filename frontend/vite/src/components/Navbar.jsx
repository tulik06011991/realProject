...
const Navbar = () => {
    ...
    useEffect(() => {
        const savedMode = localStorage.getItem('Mode'); // Corrected 'Mode' to be a string
        if (savedMode) {
    ...
    const toggleMode = () => {
        ...
        setDarkMode(newMode);
        localStorage.setItem('Mode', newMode); // Corrected 'Mode' to be a string
    };
                ...
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                            ...
                            <div className="flex space-x-4">
                                    <Link to="/register" className="text-gray-300 hover:bg-gray-700 hover:text-white ml-5 rounded-md px-3 py-2 text-sm font-medium">Register</Link>
                                ...
                                <button className={darkMode ? 'dark-mode' : 'light-mode'} onClick={toggleMode} >darkmode</button>
                        </div>
                    </div>
                </div>
